...
from ppuda.vision.loader import image_loader, to_few_shot
...
def main():
    ...
    # EL following lines are checking the consistency of the loaded data
    # print('train_queue length:', len(train_queue))

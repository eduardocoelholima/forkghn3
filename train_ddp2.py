...
def main():
    ...
    model = eval(f'torchvision.models.{args.arch}(num_classes=10)')
    ...
    if args.dataset=='cifar100':
        data_transforms = transforms_cifar10()
    ...
    if args.dataset=='cifar100':
        model.fc = nn.Linear(2048,100).to(device='cuda')
    elif args.dataset=='cifar10':
        model.fc = nn.Linear(2048,10).to(device='cuda')
